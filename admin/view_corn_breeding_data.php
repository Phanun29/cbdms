...
$cbd_query = "SELECT  t.*, GROUP_CONCAT(ti.image_path SEPARATOR ',') AS image_paths
              ...
              WHERE cbd_id = $cbd_id OR  t.name_of_cut_corn_variety = '$name_of_cut_corn_variety'
          ...
          <div class="card shadow mb-4">
            ...
            <form action="" class="row mt-3 px-3">
              <div class="col-12 col-md-6 row">
                ...
                if ($status) {
                  echo " <a href='view_corn_breeding_data.php?id={$cbd['cbd_id']}&name_of_cut_corn_variety={$cbd['first_corn_variety']}' class='form-control col-6 text-primary mb-3'>{$cbd['first_corn_variety']}</a>";
                } else {
              ...
              <div class="col-12 col-md-6 row">
                ...
                if ($status) {
                  echo " <a href='view_corn_breeding_data.php?id={$cbd['cbd_id']}&name_of_cut_corn_variety={$cbd['second_corn_variety']}' class='form-control col-6 text-primary mb-3'>{$cbd['second_corn_variety']}</a>";
                } else {
